...
export function NutriContextProvider(props) {
  ...
  const [favePics, setFavePics] = useState([]);
  ...
  function updateFavePicsHandler(newFavePics) {
    setFavePics(newFavePics);
  }
  ...
  const context = {
    ...
    favePics,
    updateFavePics: updateFavePicsHandler,
    faveClicked,
